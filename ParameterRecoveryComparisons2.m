function ParameterRecoveryComparisons2

% test recovery of 2arms
% compare with or without priors (MLE versus MAP)
...
fith = @lik_RW1lr_2arms_PL_native;
simuh = @RW1lr_2arms_plsim;
